...
<div>
    <div style="float: left;"><p>
      <?php if($id =='add'){  ?>
        <?= Html::a('Create Category', [$id], ['class' => 'btn btn-primary yellow-btn-box']) ?>
        <?php } else{  ?>
        <?= Html::a('Add Child Category', [$id], ['class' => 'btn btn-primary yellow-btn-box']) ?>
            <?php } ?>
        <?= Html::a('Reset', ['/backend/category/manager/'], ['class'=>'btn btn-danger red-btn-box']) ?>
        <?= Html::a('Sort', ['/backend/category/sort?id='.$pid], ['class'=>'btn btn-danger yellow-btn-box']) ?>  
    </p>
            ...
            <ul>
             ...
             <?php
               if(empty($str_data[0])){ 
                ...
                <li><a href="<?php echo Yii::$app->urlManager->createUrl(['/backend/category/manager']) ?>">Root</a></li>
