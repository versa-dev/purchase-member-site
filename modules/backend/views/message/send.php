                ...
                <div class="white-wrapper">
                    <div class="white-wrapper-inner compos-area">
                        <ul class="nav nav-pills nav-stacked mailbox-sidenav">
                            <li> <a href="<?= Yii::$app->urlManager->createAbsoluteUrl('backend/message/compose') ?>"><i class="fa fa-edit"></i> Compose Message</a></li></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">
                                                ...
                                                ?>
                                                <span class="text-muted"><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['/message/send-view', 'id' => $row->id]) ?>"> <?= substr(strip_tags($row->message), 0, 200); ?> ...</span>
                                                <?php
                                                if ($row->mark_read == 0) {
                                                    //echo '</b>';
                                                }
