  ...
  $('#'+id).append(unescape(response));
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6">
        <?= $form->field($model, 'item_name')->textInput(['maxlength' => true])->label('Description_Sage*') ?>
      </div>
      <div class="col-md-6 col-sm-6">
        <?= $form->field($model, 'item_code')->textInput(['maxlength' => true])->label('Item Code*') ?>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
         <?= $form->field($model, 'description')->textarea(['rows' => 6])->label('Description_Web*') ?>
      </div>
      <!-- <div class="col-md-6 col-sm-6">
       <?php //echo  $form->field($model, 'product_category')->textarea(['rows' => 6])->label('Product Category*') ?>
      </div> -->
