...
<div class="product-form">
    ...
    <div class="col-md-12 col-sm-12 form-group">
     ...
     <?php if(empty($sub_cat_list) || empty($sub_cat_list[0])){ ?>
...
<div class="row">
      ...
      <div class="col-md-4 col-sm-4">
       ...
       <div class="col-md-4 col-sm-4">
         <?php  $htmloption=array('1'=>'Approve','0'=>'Unapprov');?>
            <?= $form->field($model, 'status')->dropDownList($htmloption,['prompt'=>'Select status','class'=>'form-control drop'])?>
        </div>
...
<td><?php if($value['product']['status']==1){ echo "Approve"; } else{ echo 'Unapprov';}?></td>
