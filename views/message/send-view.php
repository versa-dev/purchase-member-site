            ...
            <div>
              ...
              <div class="white-wrapper-inner compos-area">
                            <ul class="nav nav-pills nav-stacked mailbox-sidenav">
                                <li> <a href="<?= Yii::$app->urlManager->createAbsoluteUrl('/message/compose') ?>"><i class="fa fa-edit"></i> Compose Message</a></li>
                    ...
                    <div class="col-md-9 col-sm-8">
                        ...
                        if (count($rPath) > 0) {
                            ...
                            foreach ($rPath as $id => $p) {
                                ...
                                $md->mark_read = 1;
                                $md->update();
                                $from = (int) $md->to_user > 0 ? ucfirst(\app\models\User::findOne(['id' => $md->to_user])->username) : $md->to_user;
                                ?>
                                <div class="white-wrapper">
              <div class="white-wrapper-inner compos-area">
                                
                                    <div class="panel-heading text-right">Send Member: <?= $from ?></div>
