...
$this->title='Report an EMT, Email Money Transfer, to  WebPicID.com Canada only';
?>
...
<script>
    ...
    j( function() {
        j("#reportdepositemt-payment_date_time").datepicker({
            changeMonth: true,
            changeYear: true,
            yearRange: '1920:' + '2025',
            dateFormat: 'yy-mm-d'
    ...
    j(document).ready(function () {
        ...
        s = checkTime(s);
        var today_time= h + ":" + m;
        j('#reportdepositemt-payment_time').val(today_time);
