        ...
        <div class="col-md-6"  style="<?php if(!empty(yii::$app->user->id)){ echo "display: none"; }?>">
          ...
          <div class="site-login">
            ...
            <div class="remember-box">
              <div class="row">
                <div class="col-md-6 col-sm-12 forgot-pass" style="text-align: left;">
                  <a href="<?php echo Yii::$app->urlManager->createUrl(['/site/register']); ?>">Sign Up</a>
                </div>
                ...
                <div class="col-md-6 col-sm-12 forgot-pass" style="text-align: right;">
