...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function getRstaus()
    {
        return $this->hasOne(Status::className(), ['id' => 'status']);
    }
    public function getModificationstatus()
    {
        return $this->hasOne(ModificationStatus::className(), ['id' => 'modification_status']);
    }
    public function getSedirectory()
    {
        return $this->hasOne(SeDirectory::className(), ['id' => 'se_directory']);
    }
