 ...
 */
class ProfileQuestionAnswer extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'profile_question_answer';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['question_id'], 'exist', 'skipOnError' => true, 'targetClass' => ProfileQuestion::className(), 'targetAttribute' => ['question_id' => 'id']],
        ];
    }
