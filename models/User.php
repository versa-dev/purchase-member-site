...
class User extends ActiveRecord implements \yii\web\IdentityInterface {
  ...
  public function rules()
    ...
    {
        return $this->hasOne(AgentIdentification::className(), ['user_id' => 'id']);
    }
    public function getFamilyProtection()
    {
        return $this->hasOne(FamilyProtection::className(), ['user_id' => 'id']);
    }
     public function getFamilyProtectionMember()
    {
        return $this->hasOne(FamilyProtectionMember::className(), ['family_protection_id' => 'id'])->via('familyProtection');;
    } 
}
